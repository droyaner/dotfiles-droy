...
vim.keymap.set("n", "<leader>gh", "<cmd>Git log --oneline --graph --decorate<cr>", { desc = "Git log" })
vim.keymap.set("n", "<leader>gV", "<cmd>Gvdiffsplit<cr>", { desc = "Git vertical diff" })
vim.keymap.set("n", "<leader>gW", "<cmd>Gwrite<cr>", { desc = "Git stage file" })
vim.keymap.set("n", "<leader>gR", "<cmd>Gread<cr>", { desc = "Git reset file" })
vim.keymap.set("n", "<leader>gO", "<cmd>GBrowse<cr>", { desc = "Git browse remote" })
